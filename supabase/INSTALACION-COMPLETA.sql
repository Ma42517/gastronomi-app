...
-- Contiene, en orden:
--   1) Esquema base.
--   2) 001: columnas del Panel Administrador.
--   3) 002: permisos de la Data API.
--   4) 003: endurecimiento de permisos del rol publico.
--   5) 004: arreglo del indice del upsert.
--   6) 005: duenos del restaurante (login del panel).
--   7) 006: super admins de la plataforma.
--   8) 007: ajustes globales de la app (fuentes, pagos, promos, candados).
-- ============================================================================
